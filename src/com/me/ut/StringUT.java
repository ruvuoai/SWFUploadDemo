...
public class StringUT {
     ...
     * @return
     */
    public static String getUploadFilesPath(String files, String fieldName) {
	...
	for (int i = 0; i < arr.length; i++) {
		...
		try {
		    map.put(item[0], URLDecoder.decode(item[1], "UTF-8"));
    ...
    public static String getV(Map map, String key) {
     ...
     * @param str
     */
    public static void fillStringBuilder(StringBuilder stringBuilder, String str) {
	if (stringBuilder == null) {
	    return;
	}
	stringBuilder = stringBuilder.delete(0, stringBuilder.toString()
		.length());
	...
	fillStringBuilder(stringBuilder, "adc");
    }
